 ...
 */
// @ts-ignore
var bitget_svg_1 = __importDefault(require("../assets/bitget.svg"));
var types_1 = require("../types");
var BaseWallet_1 = __importDefault(require("./BaseWallet"));
var web3_1 = __importDefault(require("web3"));
var BitgetWallet = /** @class */ (function (_super) {
    __extends(BitgetWallet, _super);
    function BitgetWallet() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = types_1.EnumWalletName.BitgetWallet;
        _this.icon = bitget_svg_1.default;
        _this.supportChains = [
     ...
     */
    BitgetWallet.prototype.requestConnect = function (chainId) {
                ...
                switch (_a.label) {
                    case 0:
                        if (!(window.isBitKeep && window.bitkeep.ethereum)) {
                            throw new Error(types_1.EnumErrors.NoBitget);
                        }
